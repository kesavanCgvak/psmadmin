...
/**
 * Structured Rentman integration lines on the stack channel and storage/logs/rentman-integration.log.
 */
final class RentmanIntegrationDebugLog
{
    ...
    /**
     * Log a full Rentman HTTP request/response for debugging.
     *
    ...
    public static function apiCall(
        ...
        $step = self::nextStepNumber($rentalRequestId, $providerId);
        $previewMax = (int) config('rentman.log_response_preview_max', 8000);
    ...
    public static function write(
        ...
        $context = array_merge([
            ...
            'rentman_action' => $action,
            'rentman_status' => $status,
        ], $details);

        foreach (['stack', 'rentman'] as $channel) {
            try {
