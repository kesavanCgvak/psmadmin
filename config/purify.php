...
return [
    ...
    */
    ...
    'configs' => [
        ...
        /*
         * Rich HTML from TinyMCE / similar WYSIWYG editors (admin CMS pages, legal text).
         * Strips scripts, event handlers, and dangerous URLs while keeping common formatting.
         */
        'wysiwyg' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,sub,sup,a[href|title|target|rel],ul,ol,li,p[style|class],br,span[style|class],img[width|height|alt|src|class|style],blockquote,hr,table[class|style],thead,tbody,tfoot,tr,th[colspan|rowspan|style|class],td[colspan|rowspan|style|class],div[style|class]',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding,padding-left,padding-right,padding-top,padding-bottom,margin,margin-left,margin-right,margin-top,margin-bottom,color,background-color,text-align,border,border-width,border-style,border-color,width,max-width,height',
            'AutoFormat.AutoParagraph' => false,
            'AutoFormat.RemoveEmpty' => false,
        ],
