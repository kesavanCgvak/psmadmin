...
@section('title', 'Create Weight Unit')

@section('content_header')
    <h1>Create New Weight Unit</h1>
@stop
...
@section('content')
    <div class="card card-success">
        ...
        <form action="{{ route('admin.weight-units.store') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-save"></i> Create Weight Unit
                </button>
